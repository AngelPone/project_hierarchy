...
\renewcommand\thefigure{S.1}
    \centering
    %\vspace{-0.1in}
    \includegraphics[width=0.5\textwidth]{../manuscript/figures/tourism/mcb_combination_middle.pdf}
    \includegraphics[width=0.5\textwidth]{../manuscript/figures/mortality/mcb_combination_middle.pdf}
