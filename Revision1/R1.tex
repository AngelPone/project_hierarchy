...
We also consider the in-sample one-step-ahead forecast error as a representation of the time series, since a key step in MinT reconciliation is to estimate the $\boldsymbol{W}$ matrix. %to examine how the structure within the error series influences reconciliation performance. 
...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.47\textwidth]{../manuscript/figures/tourism/natural_vs_pn.pdf}
    \centering    \includegraphics[width=0.47\textwidth]{../manuscript/figures/mortality/natural_vs_pn.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.47\textwidth]{../manuscript/figures/tourism/cluster_vs_pc.pdf}
    \includegraphics[width=0.47\textwidth]{../manuscript/figures/mortality/cluster_vs_pc.pdf}
...
\begin{figure}[h!]
    \centering
    \vspace{0.1in}\includegraphics[width=0.7\textwidth]{../manuscript/figures/simulation/P3_mcb.pdf}
   \vspace{-0.1in}
...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.8\textwidth]{../manuscript/figures/simulation/P3_c_vs_pc.pdf}
    \vspace{-0.1in}
...
\begin{figure}[h!]
    \centering
    %\vspace{-0.2in}
    \includegraphics[width=0.45\textwidth]{../manuscript/figures/tourism/mcb_combination.pdf}
    \includegraphics[width=0.45\textwidth]{../manuscript/figures/mortality/mcb_combination.pdf}
...
%\vspace{-0.15in}
    \centering
    \includegraphics[width=0.6\textwidth]{../manuscript/figures/mortality/comb_vs_pc.pdf}
